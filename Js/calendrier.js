...
function saveNext(){
    ...
    // alert('date suivante, en cours de développement'); //todo date suivante
}
...
function savePrevious(){
    ...
    alert ( 'sauvegardes du '+ date + ' effectuée ' ) ;
    $('#myform').attr('action', "../Inc/saveMultiTasks.php");
    // alert('date précédente, en cours de développement'); //todo date precedente
}
...
function initAjaxForm(){
    ...
    $('#dialog-form input[name="save_next"]').on('click', function(e){
        ...
        $('#myform').submit();
        e.preventDefault();
        // enregistrement ok . mettre la date a la demi journée
