...
return array(
    ...
    'image_width'      => 375,       // width of captcha image in pixels
    'image_height'     => 200,       // height of captcha image in pixels
    'code_length'      => 1,         // # of characters for captcha code
...
//    'num_lines'        => 4,         // # of lines to draw over text
    'num_lines'        => 1,         // # of lines to draw over text
//    'noise_level'      => 4,         // how much random noise to add (0-10)
    'noise_level'      => 0,         // how much random noise to add (0-10)
//    'perturbation'     => 0.7,       // distoration level
    'perturbation'     => 1,       // distoration level
